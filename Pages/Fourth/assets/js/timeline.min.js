          ...
          : (function (i) {
              ...
              i.items.forEach(function (e, t) {
                e.classList.remove('animated', 'fadeIn'),
                  ...
                  t % 2 == ('left' === i.settings.verticalStartPosition ? 1 : 0) && window.innerWidth > i.settings.forceVerticalMode
    ...
    [].forEach.call(e, function (e) {
      ...
      Object.keys(b).forEach(function (e) {
        ...
        ;(r[e] = b[e].defaultValue),
          ...
          'integer' === b[e].type
            ? (r[e] && ((t = r[e]), (i = e), 'number' == typeof t || t % 1 == 0 || (console.warn(p + ' The value "' + t + '" entered for the setting "' + i + '" is not an integer.'), 0))) ||
              (r[e] = b[e].defaultValue)
            : 'string' === b[e].type &&
              b[e].acceptedValues &&
      ...
      ;(r.verticalTrigger = { unit: u, value: m }),
        ...
        r.startIndex > a.length - r.visibleItems && a.length > r.visibleItems
          ? (console.warn(
              p + " The 'startIndex' setting must be between 0 and " + (a.length - r.visibleItems) + ' for this timeline. The value of ' + (a.length - r.visibleItems) + ' has been used instead.'
            ),
          ...
          : r.startIndex < 0 &&
            (console.warn(p + " The 'startIndex' setting must be between 0 and " + (a.length - r.visibleItems) + ' for this timeline. The value of 0 has been used instead.'), (r.startIndex = 0)),
